...
class domain_predictor(nn.Module):
    def __init__(self, n_domains=2, init_features=4):
        ...
        self.domain.add_module('r_fc1', nn.Linear(120, 96))
...
class UNet3D(nn.Module):
    def __init__(self, in_channels=1, init_features=4):
        ...
        self.decoder1 = UNet3D._half_block(features * 2, features, name="dec1")
...
class segmenter3D(nn.Module):
    def __init__(self, out_channels=4, init_features=4):
        super(segmenter3D, self).__init__()
        features = init_features

        self.relu1 = nn.ReLU(inplace=True)
        self.batchnorm1 = nn.BatchNorm3d(num_features=features)
        self.decoder1 = segmenter3D._half_block(features, features, name="dec1")
...
class domain_predictor3d(nn.Module):
    def __init__(self, n_domains=2, init_features=4):
        super(domain_predictor3d, self).__init__()
        self.n_domains = n_domains
        features = init_features

        self.decoder1 = domain_predictor3d._half_block(features, features, name="conv1")
        self.pool1 = nn.MaxPool3d(kernel_size=2, stride=2)
        self.decoder2 = domain_predictor3d._half_block(features, features, name="conv2")
        self.pool2 = nn.MaxPool3d(kernel_size=2, stride=2)
        self.decoder3 = domain_predictor3d._half_block(features, features, name="conv3")
        self.pool3 = nn.MaxPool3d(kernel_size=2, stride=2)
        self.decoder4 = domain_predictor3d._half_block(features, features, name="conv3")
        self.pool4 = nn.MaxPool3d(kernel_size=2, stride=2)
        self.decoder5 = domain_predictor3d._projector_block(features, 1, name="projectorblock")
        # Projector block to reduce features
        self.domain = nn.Sequential()
        self.domain.add_module('r_fc1', nn.Linear(120, 96))
        self.domain.add_module('r_relu1', nn.ReLU(True))
...
class domain_predictor3D(nn.Module):
    def __init__(self, n_domains=2, init_features=4):
        ...
        # Projector block to reduce features
        self.domain = nn.Sequential()
        self.domain.add_module('r_fc1', nn.Linear(2040, 120))
        self.domain.add_module('r_relu1', nn.ReLU(True))
        self.domain.add_module('d_fc2', nn.Linear(120, 32))
        self.domain.add_module('d_relu2', nn.ReLU(True))
        self.domain.add_module('d_fc3', nn.Linear(32, n_domains))
        self.domain.add_module('d_pred', nn.Softmax(dim=1))
